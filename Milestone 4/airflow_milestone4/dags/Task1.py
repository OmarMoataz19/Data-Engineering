...
def read_clean_transform_load_task (filename):
    if not os.path.exists("./data/green_tripdata_2016-01_task1.csv"):
        # Read DataSet
        dataSet_path = "./data/"
        ...
        df_copy.to_csv('./data/green_tripdata_2016-01_beforeEncoding.csv', index=False, header=True)
        ...
        df_copy.to_csv('./data/green_tripdata_2016-01_task1.csv', index=False, header=True)